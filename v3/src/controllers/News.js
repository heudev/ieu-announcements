...
const TurkishNewsController = new News(TurkishNewsService, 'tr', process.env.TELEGRAM_CHAT_ID_TURKISH);
const EnglishNewsController = new News(EnglishNewsService, 'en', process.env.TELEGRAM_CHAT_ID_ENGLISH);
