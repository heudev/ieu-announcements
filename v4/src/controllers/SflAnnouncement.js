...
const TurkishSflAnnouncementController = new SflAnnouncement(TurkishSflAnnouncementService, 'tr', process.env.TELEGRAM_CHAT_ID_TURKISH);
const EnglishSflAnnouncementController = new SflAnnouncement(EnglishSflAnnouncementService, 'en', process.env.TELEGRAM_CHAT_ID_ENGLISH);
