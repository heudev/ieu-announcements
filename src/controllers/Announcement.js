...
const TurkishAnnouncementController = new Announcement(TurkishAnnouncementService, 'tr', process.env.TELEGRAM_CHAT_ID_ANNOUNCEMENT_TURKISH);
const EnglishAnnouncementController = new Announcement(EnglishAnnouncementService, 'en', process.env.TELEGRAM_CHAT_ID_ANNOUNCEMENT_ENGLISH);
